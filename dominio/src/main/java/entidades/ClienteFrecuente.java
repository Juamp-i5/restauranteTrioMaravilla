...
public class ClienteFrecuente extends Cliente implements Serializable {
    ...
    public ClienteFrecuente(String nombres, String apellidoPaterno, String apellidoMaterno, String telefono, String correoElectronico, LocalDate fechaRegistro) {
        super(nombres, apellidoPaterno, apellidoMaterno, telefono, correoElectronico, fechaRegistro);
    }
